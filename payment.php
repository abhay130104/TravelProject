...
<html lang="en">
  ...
  body{
    ...
    background-image: url('images/img-payment.jpg');
...
<body>
    <div class="wrapper">
        ...
        <form action="book_form.php" method="POST">
            ...
            <div class="input-group">
                <div class="input-box">
                    <input type="int" placeholder="Enter Id" required class="name" name="ID">
            ...
            <div class="input-group">
                ...
                <div class="exp">
                Expiry<input type="date" placeholder = "Expiry" required name="date">
            </div>
            </div>
            <div class="input-group">
                <div class="input-box">
                PAY NOW &nbsp&nbsp&nbsp<input type="submit" name="pt"></input>
                </div>
            </div>
        </form>
    </div>
